...
flags.DEFINE_string('DATA_DIR', 'gs://mr-lyrics-autocomplete-data/lyrics.txt', "")
...
flags.DEFINE_integer('ITERATIONS_PER_SEQ_LENGTH', 100, '')
...
flags.DEFINE_integer('SAVE_CHECKPOINTS_EVERY', 25, '')
