...
import tutorial_common as common
...
common.visualize_digits(check_real_digits)
...
def discriminator_fn(img, unused_conditioning, weight_decay=2.5e-5,
    ...
    with framework.arg_scope(
        ...
        activation_fn=common.leaky_relu, normalizer_fn=None,
        weights_regularizer=layers.l2_regularizer(weight_decay),
...
common.visualize_digits(check_generated_digits)
...
for gan_loss, name in [(vanilla_gan_loss, 'vanilla loss'), 
    ...
    common.evaluate_tfgan_loss(gan_loss, name)
...
def eval():
  ...
  return eval_score, frechet_distance, generated_data_to_visualize

def train(eval_score, frechet_distance, generated_data_to_visualize):
  ...
  with tf.train.SingularMonitoredSession() as sess:
      ...
      for i in xrange(1601):
          ...
          if i % 50 == 0:
              ...
              common.visualize_training_generator(i, start_time, digits_np)

      return loss_values, mnist_scores, frechet_distances
...
eval_score, frechet_distance, generated_data_to_visualize = eval()
loss_values, mnist_scores, frechet_distances = train(eval_score, frechet_distance, generated_data_to_visualize)
